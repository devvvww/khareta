...
@section('content')
    ...
    <div class="flex flex-col items-center px-4 md:px-6 py-4 md:py-6">
        ...
        <div class="course-flow-page flex flex-col min-h-dvh md:min-h-0 md:h-auto overflow-y-auto">
                ...
                @if ($carousel->count() > 1)
                    <div id="course-carousel" class="course-carousel">
                        @foreach ($carousel as $item)
                            <div class="course-carousel-slide current-course-card block rounded-3xl text-white text-center px-6 py-6 md:py-10"
